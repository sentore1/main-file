...
export default function Index() {
    ...
    const handleExport = () => {
        ...
        if (filters.from_warehouse) params.append('from_warehouse', filters.from_warehouse);
        
        window.location.href = route('transfers.export') + (params.toString() ? '?' + params.toString() : '');
    };
