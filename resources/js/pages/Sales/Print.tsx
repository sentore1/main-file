...
export default function Print() {
    ...
    const footerDetails = getWarehouseFooterDetails(invoice.warehouse_id);
    const branchName = getBranchName(invoice.warehouse_id);

    // Debug logo
    console.log('Company Logo:', getCompanySetting('company_logo'));
    console.log('Logo Path:', getImagePath(getCompanySetting('company_logo')));
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <div className="invoice-container bg-white max-w-4xl mx-auto p-8">
                ...
                <div className="flex justify-between items-end mb-4 page-break-inside-avoid">
                    {/* Stamp Image */}
                    <div className="w-64">
