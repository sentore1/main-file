...
export default function Report() {
    ...
    const downloadPDF = async () => {
        ...
        if (reportContent) {
            const opt = {
                margin: 0.25,
                filename: `sales-invoices-report-${new Date().toISOString().split('T')[0]}.pdf`,
    ...
    return (
        <div className="min-h-screen bg-white">
            <Head title={t('Sales Invoices Report')} />
            ...
            <div className="report-container bg-white max-w-7xl mx-auto p-8">
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-3xl font-bold mb-2">{t('Sales Invoices Report')}</h1>
                        ...
                        <tbody>
                            {invoices.map((invoice) => (
                                <tr key={invoice.id}>
                                    ...
                                    <td className="border border-gray-300 px-4 py-2">{invoice.customer?.name || '-'}</td>
