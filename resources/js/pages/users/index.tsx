...
import { Plus, Edit, Trash2, Key, Users as UsersIcon, User as UserIcon, UserCheck, History, Lock, Upload } from "lucide-react";
...
export default function Index() {
    ...
    const openModal = (mode: 'add' | 'edit' | 'change-password' | 'import', data: User | null = null) => {
        setModalState({
            isOpen: true,
            mode,
            data
        ...
        >
            ...
            <Dialog open={modalState.isOpen} onOpenChange={closeModal}>
                ...
                {modalState.mode === 'import' && (
                    <ImportUsers onSuccess={closeModal} />
                )}
            </Dialog>
