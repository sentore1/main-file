...
Route::middleware(['auth', 'verified'])->group(function () {
    // Removed PlanModuleCheck middleware for non-SaaS version
    ...
    Route::post('users/import/upload', [UserController::class, 'import'])->name('users.import');
    ...
    Route::get('purchase-invoices-report/download', [PurchaseInvoiceController::class, 'downloadReport'])->name('purchase-invoices.download-report');
    ...
    Route::get('sales-invoices-report/download', [SalesInvoiceController::class, 'downloadReport'])->name('sales-invoices.download-report');
    ...
    */
    // SaaS Routes - Commented out for non-SaaS version
    /*
    ...
    */
    ...
    // Bank Transfer Payment routes - Commented out for non-SaaS
    /*
