...
class PermissionRoleSeeder extends Seeder
{
    public function run()
    {
        ...
        // Commented out superadmin creation for non-SaaS version
        /*
        ...
        */
        ...
        // Create Company User for non-SaaS
        $company = User::firstOrCreate(
            ['email' => 'company@example.com'],  // Changed for non-SaaS
            [
                'name' => 'Company',         // Changed for non-SaaS
                'email_verified_at' => now(),
                'password' => Hash::make('1234'),  // Changed for non-SaaS
                'mobile_no' => '1234567890',
                'type' => 'company',
                'lang' => 'en',
                'creator_id' => null,              // Removed superadmin dependency
                'created_by' => null               // Removed superadmin dependency
            ]
        );
            ...
            'company' => [
                ...
                'permissions' => [
                    ...
                    */
                    ...
                    'manage-languages', 'edit-languages',
                    ...
                    // Added admin permissions for non-SaaS version
                    'manage-email-templates', 'edit-email-templates',
                    'manage-notification-templates', 'edit-notification-templates',
                    'manage-cache-settings', 'clear-cache',
                    'manage-cookie-settings', 'edit-cookie-settings',
                    'manage-seo-settings', 'edit-seo-settings',
                    'manage-storage-settings', 'edit-storage-settings',
                    'manage-pusher-settings', 'edit-pusher-settings',
                    // 'manage-bank-transfer-settings', 'edit-bank-transfer-settings',
                    'manage-plans', 'manage-any-plans', 'manage-own-plans', 'view-plans', 'create-plans', 'edit-plans', 'delete-plans',
        ...
        foreach ($roles as $roleName => $roleData) {
            // Skip superadmin role for non-SaaS
            ...
            $role = Role::firstOrCreate(
                ...
                [
                    ...
                    'editable' => false,
                    // 'created_by' => $company->id  // Use company instead of superadmin
                ]
            );
        ...
        // Remove superadmin role assignment
