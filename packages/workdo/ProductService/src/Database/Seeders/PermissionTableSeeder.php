...
class PermissionTableSeeder extends Seeder
{
    public function run()
    {
        ...
        $permission = [
            ...
            ['name' => 'manage-stock-report', 'module' => 'stock-report', 'label' => 'Manage Stock Report'],
            ['name' => 'view-stock-report', 'module' => 'stock-report', 'label' => 'View Stock Report'],
            ['name' => 'create-stock-report', 'module' => 'stock-report', 'label' => 'Create Stock Report'],
            ['name' => 'delete-stock-report', 'module' => 'stock-report', 'label' => 'Delete Stock Report'],
