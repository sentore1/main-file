            ...
            [
                ...
                'content' => '<div class="space-y-8">
                    <div class="text-center">
                        ...
                        <p class="text-lg text-gray-600 max-w-3xl mx-auto">ERPGo is dedicated to providing robust business solutions that help companies streamline their operations and achieve sustainable growth.</p>
                    </div>
            ...
            [
                ...
                'content' => '<div class="space-y-6">
                    <div>
                        ...
                        <p class="text-gray-600 leading-relaxed">At ERPGo, we take the security of your business data seriously. This policy outlines how we collect, use, and protect your information.</p>
                    </div>
                    ...
                    <div class="bg-gray-50 rounded-lg p-6">
                        ...
                        <p class="text-gray-600">If you have any questions about this Privacy Policy, please contact us at privacy@erpgo.com</p>
                    </div>
                </div>',
            ...
            [
                ...
                'content' => '<div class="space-y-6">
                    ...
                    <div class="rounded-lg p-6" style="background-color: color-mix(in srgb, var(--color-primary) 5%, white);">
                        ...
                        <p class="text-gray-600">If you have any questions about these Terms of Service, please contact us at legal@erpgo.com</p>
                    </div>
                </div>',
                ...
                'content' => '<div class="space-y-8">
                    ...
                    <div class="space-y-6">
                        <div class="bg-white border rounded-lg p-6">
                            <h3 class="text-lg font-semibold text-gray-900 mb-3">What is ERPGo?</h3>
                            <p class="text-gray-600 leading-relaxed">ERPGo is a comprehensive business management platform that helps companies streamline their operations, manage projects, and improve productivity through integrated tools and modules.</p>
                        </div>
                        ...
                        <div class="bg-white border rounded-lg p-6">
                            ...
                            <p class="text-gray-600 leading-relaxed">Yes! ERPGo offers extensive customization options including custom fields, workflows, dashboards, and integrations with third-party tools.</p>
                        </div>
                    </div>
