...
interface EditEmployerContributionProps {
    employerContribution: EmployerContribution;
    employerContributionTypes: Array<{ id: number; name: string }>;
    onSuccess: () => void;
}

export default function Edit({ employerContribution, employerContributionTypes, onSuccess }: EditEmployerContributionProps) {
    const { t } = useTranslation();
    
    const { data, setData, put, processing, errors } = useForm({
        employer_contribution_type_id: employerContribution.employer_contribution_type_id.toString(),
        type: employerContribution.type,
        amount: employerContribution.amount.toString(),
    });

    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(route('hrm.employer-contributions.update', employerContribution.id), {
    ...
    return (
        <DialogContent className="max-w-md">
            <DialogHeader>
                <DialogTitle>{t('Edit Employer Contribution')}</DialogTitle>
            </DialogHeader>
