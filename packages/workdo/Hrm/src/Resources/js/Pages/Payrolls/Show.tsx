...
import { Calculator, Users, DollarSign, Calendar, Download, Eye, Trash2, CreditCard, FileDown, Filter } from "lucide-react";
                            ...
                            <div className="flex items-center gap-3">
                                <Button
                                    ...
                                    onClick={() => {
                                        ...
                                        const url = `/hrm/payrolls/${payroll.id}/export-excel${branchParam}`;
                                ...
                                <Button
                                    ...
                                    onClick={() => {
                                        const branchParam = selectedBranch && selectedBranch !== 'all' ? `?branch_id=${selectedBranch}` : '';
                                        const url = route('hrm.payrolls.export', payroll.id) + branchParam;
