...
use Workdo\Hrm\Http\Controllers\EmployerContributionTypeController;

use Workdo\Hrm\Http\Controllers\EmployerContributionController;
...
Route::middleware(['web', 'auth', 'verified', 'PlanModuleCheck:Hrm'])->group(function () {
    ...
    Route::prefix('hrm/employees')->name('hrm.employees.')->group(function () {
        ...
        Route::get('/download-template', [EmployeeController::class, 'downloadTemplate'])->name('download-template');
    ...
    Route::prefix('hrm/employer-contribution-types')->name('hrm.employer-contribution-types.')->group(function () {
        Route::get('/', [EmployerContributionTypeController::class, 'index'])->name('index');
        Route::post('/', [EmployerContributionTypeController::class, 'store'])->name('store');
        Route::put('/{employerContributionType}', [EmployerContributionTypeController::class, 'update'])->name('update');
        Route::delete('/{employerContributionType}', [EmployerContributionTypeController::class, 'destroy'])->name('destroy');
    });
    ...
    // Employer Contributions routes
    Route::prefix('hrm/employer-contributions')->name('hrm.employer-contributions.')->group(function () {
        Route::post('/', [EmployerContributionController::class, 'store'])->name('store');
        Route::put('/{employerContribution}', [EmployerContributionController::class, 'update'])->name('update');
        Route::delete('/{employerContribution}', [EmployerContributionController::class, 'destroy'])->name('destroy');
    });
