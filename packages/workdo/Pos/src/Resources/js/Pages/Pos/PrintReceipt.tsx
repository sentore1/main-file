        ...
        <div class="receipt">
                ...
                ${completedSale.items.map((item: any) => {
                    ...
                    return `
                        <div class="item">
                            ...
                            ${item.notes ? `<div style="font-size: 10px; color: #2563eb; font-style: italic; margin-bottom: 3px;">📝 ${item.notes}</div>` : ''}
                            ${item.is_room && item.includes_breakfast ? `<div style="font-size: 10px; color: #ea580c; font-weight: 600; margin-bottom: 3px;">☕ Includes Breakfast</div>` : ''}
            ...
            <div class="totals">
                ...
                ${completedSale.balance_due > 0 ? `
                    <div class="total-row" style="color: #16a34a; font-weight: 600; margin-top: 8px;">
                        <span>Paid:</span>
                        <span>${formatCurrency(completedSale.paid_amount)}</span>
                    </div>
                    <div class="total-row" style="color: #ea580c; font-weight: 600;">
