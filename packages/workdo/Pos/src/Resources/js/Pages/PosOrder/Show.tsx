...
export default function Show() {
    ...
    const getStatusBadgeClasses = (status: string) => {
        switch (status?.toLowerCase()) {
            ...
            case 'partial':
                return 'px-2 py-1 rounded-full text-sm bg-orange-100 text-orange-800';
            case 'pending':
                                    ...
                                    {sale.items?.map((item, index) => (
                                        <tr key={index}>
                                            <td className="px-4 py-4">
                                                ...
                                                {item.notes && (
                                                    <div className="text-sm text-blue-600 italic mt-1">📝 {item.notes}</div>
                                                )}
                                            </td>
                                ...
                                {sale.balance_due && sale.balance_due > 0 && (
                                    <>
                                        ...
                                        <div className="flex justify-between text-orange-600">
                                            ...
                                            <span className="font-bold">{formatCurrency(sale.balance_due)}</span>
                                        </div>
                                    </>
                                )}
                            </div>
