                    ...
                    <div className="w-80">
                        <div className="border border-gray-400 p-4">
                            <div className="space-y-2">
                                ...
                                {(sale.payment?.paid_amount !== undefined || sale.paid_amount !== undefined) && 
                                 (sale.payment?.balance_due > 0 || sale.balance_due > 0) && (
                                    <>
                                        <div className="border-t border-gray-300 pt-2 mt-2">
                                            <div className="flex justify-between text-green-600 font-semibold">
                                                <span>{t('Paid')}:</span>
                                                <span>{formatCurrency(sale.payment?.paid_amount || sale.paid_amount || 0)}</span>
                                            </div>
                                        </div>
                                        <div className="flex justify-between">
                                            ...
                                            <span className="font-medium">
                                                {(() => {
                                                    ...
                                                    const method = sale.payment?.payment_method || sale.payment_method || 'cash';
                                        ...
                                        <div className="flex justify-between text-orange-600 font-bold">
                                            ...
                                            <span>{formatCurrency(sale.payment?.balance_due || sale.balance_due || 0)}</span>
                                        </div>
                                    </>
                                )}
                            </div>
