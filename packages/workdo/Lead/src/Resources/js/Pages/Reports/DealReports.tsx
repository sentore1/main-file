...
export default function DealReports() {
    ...
    const {
        weeklyDealConversions,
        dealSourcesConversion,
        monthlyDeals,
        staffDeals,
        clientDeals,
        pipelineDeals,
    } = usePage<DealReportsProps>().props;

    const [selectedMonth, setSelectedMonth] = useState("all");
    const [fromDate, setFromDate] = useState(
        new URLSearchParams(window.location.search).get("from_date") || "",
    );
    const [toDate, setToDate] = useState(
        new URLSearchParams(window.location.search).get("to_date") || "",
    );
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <ResponsiveContainer width="100%" height={450}>
                                <BarChart
                                    data={
                                        filteredStaffDeals?.map((staff) => ({
                                            name:
                                                staff.name.length > 12
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <ResponsiveContainer width="100%" height={450}>
                                <BarChart
                                    data={
                                        filteredClientDeals?.map((client) => ({
                                            name:
